...
- 当前工作树是隔离的 MPU6050/MPU6500-compatible 硬件 spike，不是正式 Phase 2B，也不直接合入 main。
...
- 当前执行器 armed/output permitted 始终为 0；未接电机、编码器、云台或树莓派。Spike 接入
  PA0/PA1 上总线地址 `0x68`、历史 `WHO_AM_I=0x70` 的 IMU，与 OLED 共用 I2C0，已完成
  27000 秒静态稳定性测试。
...
tools\mpu6050_field_check.ps1 -Port COM4 -Mode Static -DurationSeconds 20
tools\unattended_soak_test.ps1 -Port COM4 -TotalDurationSeconds 27000 -SegmentDurationSeconds 900
...
- [`docs/spikes/MPU6050_HARDWARE_SPIKE.md`](docs/spikes/MPU6050_HARDWARE_SPIKE.md)：备用 IMU spike 边界与证据
- [`docs/worklogs/2026-07-16_mpu6050_unattended_stability.md`](docs/worklogs/2026-07-16_mpu6050_unattended_stability.md)：27000 秒无人值守稳定性记录
